...
var (
	...
	InvalidStockError            = errors.New("invalid stock")
	...
	SearchParamRequireError      = errors.New("search parameter is required")
	PageCouldNotBeFoundError     = errors.New("page could not be found")
)
